...
public class LeaveChatRoomListener extends ChatFeatureListener<Packets.Requests.Chat.LeaveChatRoom, Packets.Responses.Chat.LeaveChatRoom> {
    ...
    public void processChatFeature(SakuyaBridgeConnection connection, ChatManager chatManager, Packets.Requests.Chat.LeaveChatRoom request) {
        ...
        this.respondSuccess(connection, request);
    }
