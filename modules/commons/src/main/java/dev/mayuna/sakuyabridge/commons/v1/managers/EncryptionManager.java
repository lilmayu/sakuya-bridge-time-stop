package dev.mayuna.sakuyabridge.commons.v1.managers;
...
public class EncryptionManager {
    ...
    public void saveAsymmetricKeyPair(String fileNameWithoutExtension) throws IOException {
        ...
        try (var outputStream = new FileOutputStream(publicKeyFile)) {
            outputStream.write(asymetricKeyPair.getPublic().getEncoded());
        }

        try (var outputStream = new FileOutputStream(privateKeyFile)) {
