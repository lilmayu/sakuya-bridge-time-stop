...
import dev.mayuna.sakuyabridge.commons.v1.networking.tcp.base.translator.TimeStopTranslator;
...
public class TestServerClientCommunication {
    ...
    public void testUUIDSend() {
        ...
        server.getListenerManager().registerListener(new TimeStopListener<>(UUID.class, 100) {
    ...
    public void testTranslatorUUIDtoUUID() {
        ...
        server.getListenerManager().registerListener(new TimeStopListener<>(UUID.class, 0) {
    ...
    public void testTimeStopPacketTranslationsOtherWayAround() {
        ...
        client.getListenerManager().registerListener(new TimeStopListener<>(UUID.class, 0) {
            @Override
            public void process(@NonNull Context context, @NonNull UUID message) {
                assertEquals(uuidToSend, message);
